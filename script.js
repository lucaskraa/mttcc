...
function originalCoverEndpoint(title, author = "") {
...
function bookCoverUrl(item) {
  ...
  return originalCoverEndpoint(title, author);
}
...
function initializeBookCoverHydration() {
  // As capas são fornecidas pelo servidor, usando somente edições originais.
}
